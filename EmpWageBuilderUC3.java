...
//Add part time wage calculation 
...
public class EmpWageBuilderUC3{
      public static void main(String args[]){
         ...
         System.out.println("Employee daily Full day wage - " +calculateDailyWage);
			calculateDailyWage=0;                             // assignig zero for computation  wage for part time
         calculateDailyWage=(PART_TIME_HOUR*WAGE_PER_HOUR); //daily full day wage camputation
